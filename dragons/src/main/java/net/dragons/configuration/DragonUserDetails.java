...
import net.dragons.jpa.entity.BaseUser;
import net.dragons.jpa.entity.security.AuthenticationUser;
import net.dragons.repository.ClientRepository;
 ...
 */
@Component
public class DragonUserDetails implements UserDetailsService {
