...
public final class TheDragonHostConstant {
	...
	public static String PAYMENT_PROCESSING_MESSAGE = "";
	public static String PAYMENT_FAILED_MESSAGE = "";
	
	public static String ADMIN_UPDATE_ROOM_SUCCESS_MESSAGE = "";
	public static String ADMIN_UPDATE_ROOM_FAILED_MESSAGE = "";
